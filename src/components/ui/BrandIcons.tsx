/**
 * lucide-react 1.x removed brand glyphs, so the two profile marks the site
 * needs are inlined here. Both take `className` and paint with currentColor,
 * so they drop into the same slots a Lucide icon would.
 */
